...
/**
 * Command class that handles the addition of a new flight to the booking
 * system.
 * This class implements the Command interface and provides functionality to
 * create
 * a new flight with specified details such as flight number, origin,
 * destination,
...
public class AddFlight implements Command {
     ...
     */
    public AddFlight(String flightNumber, String origin, String destination, LocalDate departureDate, double price,
            int capacity) {
    ...
    /**
     * Executes the add flight command by creating a new flight with an
     * automatically
     * generated ID and adding it to the flight booking system.
     *
     * @param flightBookingSystem the flight booking system where the flight will be
     *                            added
     * @throws FlightBookingSystemException if there is an error while adding the
     *                                      flight,
     *                                      such as duplicate flight number or
